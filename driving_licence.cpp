...
int main()
{
    assert(driver({"John", "James", "Smith", "01-Jan-2000", "M"}) == ("SMITH001010JJ9AA"));
    assert(driver({"Johanna", "", "Gibbs", "13-Dec-1981", "F"}) == ("GIBBS862131J99AA"));
    assert(driver({"Andrew", "Robert", "Lee", "02-September-1981", "M"}) == ("LEE99809021AR9AA"));
...
// and Wales they are administered by the Driver and Vehicle Licensing Agency (DVLA)
// and in Northern Ireland by the Driver & Vehicle Agency (DVA). A driving licence is
// required in the UK by any person driving a vehicle on any highway or other road
// defined in s.192 Road Traffic Act 1988[1] irrespective of ownership of the land over
// which the road passes, thus including many which allow the public to pass over private
// land; similar requirements apply in Northern Ireland under the Road Traffic
...
// 12–13: The initial letter of the first name and middle name, padded with a 9 if
// no middle name
