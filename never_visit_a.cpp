...
{
    const std::map<int, std::string> fruit_map{
        ...
        {40, "grape"}, {41, "cherry"}, {42, "pear"}, {43, "cherry"}, {44, "pear"}, {45, "apple"}, {46, "pear"}, 
        {47, "kiwi"}, {48, "banana"}, {49, "kiwi"}, {50, "banana"}, {51, "melon"}, {52, "pineapple"}, 
        {53, "melon"}, {54, "apple"}, {55, "cucumber"}, {56, "pineapple"}, {57, "cucumber"}, {58, "orange"}, 
    ...
    while (true)
    {
        ...
        if (fruit_map.count(n))
        {
            result += fruit_map.at(n);
            break;
        }
    }
